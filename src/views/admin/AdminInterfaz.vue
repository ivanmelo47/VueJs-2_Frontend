              ...
              <div class="header-left d-flex align-items-center">
                <div class="menu-toggle-btn mr-15">
                  ...
                  >
                    ...
                    <!-- <i class="lni me-2 lni-menu"></i> Menu -->
                  </button>
                </div>
              ...
              <div class="header-right">
                ...
                <div class="profile-box ml-15">
                  ...
                  >
                    ...
                    <li>
                      <a href="#0">
                        <i class="lni lni-user"></i> Ver mi perfil
                      </a>
                    </li>
                    <li>
                    ...
                    <li class="divider"></li>
                    <li>
                      <a @click="logout"> <i class="lni lni-exit"></i> Salir </a>
                    </li>
                  </ul>
                </div>
                <!-- profile end -->
...
<script>
//import Navbar from "@/components/NavbarComponent.vue"; // Navbar de administrador
import { loadScript } from '@/utils/loadScript';

export default {
  name: "AdminLayoutcopy",
  data() {
    return {
  ...
  /* mounted() {
    ...
    if (
      ...
      // Almacenar las funciones en el componente para poder remover los listeners luego
      this.toggleSidebar = () => {
      ...
      menuToggleButton.addEventListener("click", this.toggleSidebar);
  ...
  beforeDestroy() {
    ...
    if (menuToggleButton && overlay) {
      menuToggleButton.removeEventListener("click", this.toggleSidebar);
